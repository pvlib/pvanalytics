...
# daily data "completeness" score to identify and filter out days with missing data.
# This includes using :py:func:`pvanalytics.quality.gaps.completeness_score,
...
# %%
# Import the AC power data stream that we are going to check for completeness.
...
# %%
# Now, use :py:func:`pvanalytics.quality.gaps.completeness_score` to get the percentage
# of daily data that isn't NaN. 
...
# series most have at least 10 consecutive days of data that meets the completeness
# threshold. This is done using :py:func:`pvanalytics.quality.gaps.complete`
