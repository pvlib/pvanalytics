...
# %%
# First, read in the XXX example.
# This sample is provided from the NREL PVDAQ database, and contains
# a column representing an AC power data stream and a day-night
# mask column. Data associated with daytime periods is labeled as True,
# and data associated with nighttime periods is labeled as False.
